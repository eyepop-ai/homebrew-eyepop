class Eyepop < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/eyepop-ai/eyepop-cli-preview/releases/download/v0.0.1/eyepop-v0.0.1-aarch64-apple-darwin.tar.gz"
      sha256 "d4fc3502c6492f88d426d3840ee3cdafc6df50a3750e1a1ab3764192ed0c79c2"
    end
    on_intel do
      url "https://github.com/eyepop-ai/eyepop-cli-preview/releases/download/v0.0.1/eyepop-v0.0.1-x86_64-apple-darwin.tar.gz"
